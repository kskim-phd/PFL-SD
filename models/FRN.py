...
class FRN(nn.Module):
    ...
    def __init__(self,way=None,shots=None,resnet=False,is_pretraining=False,num_cat=None):
        ...
        if resnet:
            num_channel = 640
            self.feature_extractor = nn.DataParallel(ResNet.resnet12())
        ...
        # number of channels for the feature map
        self.d = num_channel
    ...
    def get_feature_map(self,inp):  #feature_map extraction
    ...
    def get_recon_dist(self,query,support,alpha,beta,Woodbury=True):  #feature map 
